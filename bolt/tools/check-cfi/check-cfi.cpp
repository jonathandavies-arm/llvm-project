...
int main(int argc, char **argv) {
  ...
  std::unique_ptr<raw_null_ostream> LogFileStream = std::make_unique<raw_null_ostream>();
  raw_ostream *BOLTJournalOut = LogFileStream.get();
  raw_ostream *BOLTJournalErr = LogFileStream.get();
